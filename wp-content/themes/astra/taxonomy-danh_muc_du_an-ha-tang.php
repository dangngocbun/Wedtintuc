        ...
        <div class="row">
            <div class="col-12 bg-banner-duan">
                ...
                <div class="title-banner">
                    <h1>DỰ ÁN</h1>
                    <p><a href="http://localhost/wp/">Home</a> >> Dự Án</p>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <h4>Không có dự án nào thuộc danh mục, vui lòng quay lại trang chủ !</h4>
                    <!-- <?php
                    $args = array( 'post_type' => 'du_an', 'post__in' => array( 0));
